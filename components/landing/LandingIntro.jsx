...
function LandingIntro(props) {
    ...
    return (
        <div className="landing-intro-container">
            <div className="landing-intro-container-left">
            ...
            <div className="landing-intro-container-right">
                <img src={logo2} className="landing-intro-logo"/>
                <img src={logo3} className="landing-intro-logo"/>
